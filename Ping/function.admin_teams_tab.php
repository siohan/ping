...
$result= array ();
$query = "SELECT *, comp.name FROM ".cms_db_prefix()."module_ping_equipes AS eq, ".cms_db_prefix()."module_ping_type_competitions AS comp WHERE comp.code_compet = eq.type_compet OR eq.type_compet IS NULL AND eq.saison = ?";

<?php
$lang['warning_cron_updated'] = 'Ce test est g&eacute;n&eacute;r&eacute; sur une base peu fr&eacute;quente. Il peut prendre un certain temps pour se terminer.';
$lang['none'] = 'Aucun';
$lang['ssl'] = 'SSL&nbsp;';
$lang['tls'] = 'TLS&nbsp;';
$lang['secure'] = 'Protocole de s&eacute;curisation&nbsp;';
$lang['info_secure'] = 'Applicable uniquement &agrave; la m&eacute;thode de courrier SMTP, cette option permet de sp&eacute;cifier les diff&eacute;rents protocoles de s&eacute;curisation pour la connexion';	
$lang['info_cmsmailer'] = 'Ce module est utilis&eacute; par de nombreux autres modules pour faciliter l&#039;envoi d&#039;emails. Il doit &ecirc;tre correctement configur&eacute; conform&eacute;ment aux exigences de votre h&eacute;bergeur. Utiliser les informations fournies par votre h&eacute;bergeur pour r&eacute;gler ces param&egrave;tres. Si vous ne parvenez toujours pas &agrave; envoyer le message de test correctement, vous devez contacter votre h&eacute;bergeur pour obtenir de l&#039;aide.';
$lang['charset'] = 'Format d&#039;encodage des caract&egrave;res&nbsp;';
$lang['sendtestmailconfirm'] = 'Ceci va envoyer un message de test &agrave; l&#039;adresse sp&eacute;cifi&eacute;e. Si le processus d&#039;envoi s&#039;effectue correctement, vous serez redirig&eacute; &agrave; nouveau vers cette page. Voulez-vous continuer&nbsp;?';
...
Si vous le recevez, c&#039;est que tout fonctionne bien.';
...
$lang['info_sendmail'] = 'Chemin complet vers votre ex&eacute;cutable sendmail (seulement valable pour la m&eacute;thode sendmail)';
...
$lang['settings_title'] = 'Param&egrave;tres';
...
<li>Version 2.0.0 - 19 avril 2010 - R&eacute;vision 29, 2010-04-19.</li>
<li>Version 2.0.1 - janvier 2011 - Suppression du bouton Annuler.</li>
<li>Version 2.0.2 - Septembre 2011 - Charset utf-8 par d&eacute;faut.</li>

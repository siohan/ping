<?php
$lang['help_idlist'] = 'Applicable uniquement &agrave; l&#039;action par d&eacute;faut (Affiche le sommaire). Ce param&egrave;tre accepte une liste s&eacute;par&eacute;e par des virgules des ID num&eacute;riques des articles et permet de filtrer davantage d&#039;articles que "articleid". La sortie de la liste actuelle des articles est toujours soumise &agrave; l&#039;&eacute;tat de l&#039;article, &agrave; date d&#039;expiration, et &agrave; d&#039;autres paramètres.';
$lang['error_nooptions'] = 'Pas d&#039;options sp&eacute;cifi&eacute;es pour la d&eacute;finition du champ';
$lang['dropdown'] = 'Liste d&eacute;roulante';
$lang['info_public'] = 'Seul les champs publiques sont uniquement disponibles pour l&#039;&eacute;dition sur le site (frontend), ou pour l&#039;affichage du r&eacute;sum&eacute; ou du d&eacute;tail.';
...
$lang['fesubmit_edit'] = 'L&#039;interface via les pages du site (frontend) permet modifier des articles&nbsp;';//-
$lang['feedit_status'] = 'Le statut des articles &eacute;dit&eacute;s via les pages du site (frontend)&nbsp;';//-
...
$lang['subject_newnews'] = 'Un nouvel article sur le site';
...
$lang['lastpage'] = '&gt;&gt;';
$lang['prompt_of'] = 'sur';
$lang['prompt_pagelimit'] = 'Nombre par pages&nbsp;';
...
$lang['nottheauthor'] = 'Vous n&#039;&ecirc;tes pas l&#039;auteur de cet article ou vous n&#039;&ecirc;tes pas autoriser &agrave; le modifier';//-
...
';
$lang['help_articleid'] = 'Ce param&egrave;tre est applicable uniquement &agrave; la vue de d&eacute;tail (Contenu). Il permet de sp&eacute;cifier que l&#039;article sera afficher en mode d&eacute;tail. Si la valeur utilis&eacute;e est -1, le syst&egrave;me affichera l&#039;article le plus r&eacute;cemment, publi&eacute;, mais non expir&eacute;.';
$lang['helpnumber'] = 'Le nombre maximal d&#039;articles &agrave; afficher -- laisser ce param&egrave;tre vide affichera tous les articles.';
$lang['helpstart'] = 'Commence au &eacute;ni&egrave;me article -- laisser ce param&egrave;tre vide commencera l&#039;affichage au premier article. C&#039;est identique au param&egrave;tre &quot;pagelimit&quot;';
...
<ul>
	...
	<li>&quot;fesubmit&quot; - <strong>Obsol&egrave;te</strong> pour afficher le gabarit de soumission (frontend) d&#039;articles des utilisateurs dans les pages du site.Ajouter le <code>{cms_init_editor}</code> dans la section des m&eacute;ta-donn&eacute;es pour initialiser l&#039;éditeur WYSIWYG s&eacute;lectionn&eacute; (Administration du site/Param&egrave;tres globaux/WYSIWYG de la partie publique).</li>
...
<p>La fa&ccedil;on la plus facile de l&#039;utiliser est avec la balise wrapper {news} (englobe le module dans une simple balise pour simplifier la syntaxe). Cela ins&egrave;rera votre module dans votre gabarit ou votre page &agrave; l&#039;endroit d&eacute;sir&eacute;, et y affichera les articles. Exemple de syntaxe dans un gabarit : <code> {news number=&#039;5&#039; detailpage=&#039;news&#039;}</code> Affichera 5 articles dans une page particuli&egrave;re news (la page avec l&#039;alias de page=news devra exister)</p>
<h3>Gabarits</h3>

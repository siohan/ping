...
$lang['help_action'] = 'Sp&eacute;cifie le comportement du module. Il ya deux possibilit&eacute;s pour ce param&egrave;tre :
  <br /> 1 - default <em>(default)</em> - Utilis&eacute; pour la construction d&#039;un menu de navigation.
  <br /> 2 - breadcrumbs - Utilis&eacute; pour construire une fil d&#039;Ariane de navigation pour la page actuellement affich&eacute;e.  <strong>Note : {cms_breadcrumbs}</strong> est une fa&ccedil;on d&#039;appeler cette action.
';
...
<p><strong>Note : </strong>pour que l&#039;affichage des infobulles sur le titres des menus et les cibles dans l&#039;onglet "option" de la page, soit actif, utiliser le gabarit menu "accessible_simple_navigation.tpl".</p>	
	...
	<p>Si vous d&eacute;sirez cr&eacute;er une version personnalis&eacute;e d&#039;un gabarit de menu, vous pouvez facilement l&#039;importer dans la base de donn&eacute;es, puis l&#039;&eacute;diter directement dans le panneau d&#039;administration de CMSMS.  Proc&eacute;der ainsi&nbsp;:</p>
		<ol>
			...
			<li>Cliquez sur l&#039;ic&ocirc;ne "Importer le gabarit dans la base de donn&eacute;es" &agrave; droite, par exemple sur la ligne simple_navigation.tpl,</li>
			<li>Donnez un nouveau nom &agrave; ce gabarit. Nous l&#039;appellerons &quot;gabarit_test&quot;</li>
...
<p>La balise <strong>{cms_breadcrumbs}</strong>(raccourci  de {menu action=breadcrumbs}) peut &ecirc;tre utilis&eacute; pour cr&eacute;er un fil d&#039;Ariane de navigation pour la page actuellement affich&eacute;e. Pour afficher le fil d&#039;Ariane dans les pages non visibles dans le menu indiquer show_all=&#039;1&#039;.</p>
';	

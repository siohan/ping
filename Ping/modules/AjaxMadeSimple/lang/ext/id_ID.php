...
$lang['moddescription'] = 'Modul khusus-pengembang memudahkan akses ke fungsionalitas-Ajax di dalam modul yang lain';
$lang['installed'] = 'Ajax Made Simple versi %s berhasil dipasang';
$lang['postinstall'] = 'Ajax Made Simple versi %s berhasil dipasang';
$lang['upgraded'] = 'Versi Ajax Made Simple berhasil diupgrade ke versi %s';
$lang['really_uninstall'] = 'Anda yakin akan mencopot Ajax Made Simple? Modul-modul yang bergantung kepadanya tidak akan dapat berfungsi lagi!';
$lang['uninstalled'] = 'Ajax Made Simple berhasil dicopot';
$lang['modulenotfound'] = 'Modul [%s] tidak ditemukan';
$lang['methodnotfound'] = 'Metode [%s] dalam modul [%s] tidak ditemukan';
$lang['changelog'] = '<ul>
<li><b>0.1.6</b> - 
<li><b>0.1.5</b> - <ul>
  <li>Menambahkan banyak komentar di dalam kode</li>
	<li>Memperbaiki bug yang sangat buruk untuk mencegah dari penyusupan javascript yang dapat muncul di berbagai kesempatan dan situasi.</li>
	<li>Menambahkan kompatibilitas mundur dengan PHP4</li>
	<li>Menambahkan beberapa perangkat yang memungkinkan Anda membuat sebuah formulir  pengunggah berkas  &quot;working/dealing&quot; dengan modul dan Ajax milik Anda</li>
	</ul></li>
...
';
$lang['utma'] = '156861353.1798521908.1197619389.1197893297.1197958479.7';
$lang['utmz'] = '156861353.1197720358.5.3.utmccn=(referral)|utmcsr=us.mg2.mail.yahoo.com|utmcct=/dc/blank.html|utmcmd=referral';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353';
?>
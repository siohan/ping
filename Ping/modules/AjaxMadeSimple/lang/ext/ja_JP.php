...
$lang['moddescription'] = '開発者のモジュールは他のモジュールから簡単にAjax機能にアクセスできます。';
$lang['installed'] = 'Ajax Made Simple version %s をインストールしました。';
$lang['postinstall'] = 'Ajax Made Simple version %s をインストールしました。';
$lang['upgraded'] = 'Ajax Made Simple version %s へアップグレードしました。';
$lang['really_uninstall'] = 'あなたはAjax Made Simpleがアンインストールしてもよろしいですか？依存ずるモジュールは機能しなくなります。';
$lang['uninstalled'] = 'Ajax Made Simple をアンインストールしました。';
$lang['modulenotfound'] = 'モジュールが存在しません。 [%s]';
$lang['methodnotfound'] = 'モジュール[%s]のメソッド[%s]が存在しません。';
$lang['changelog'] = '<ul>
<li><b>0.1.6</b> - 
<li><b>0.1.5</b> - <ul>
...
$lang['utma'] = '156861353.1193756969.1199698276.1213322938.1213926931.7';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353';
?>
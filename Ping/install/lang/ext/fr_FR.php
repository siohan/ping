...
//$lang['test_check_xml_failed'] = 'le support XML n'est pas compilé dans votre installation PHP. Vous pouvez toujours utiliser le système, mais ne serez pas en mesure d'utiliser les fonctions du Gestionnaire de Modules.'; Existe déja
...
$lang['info_estrict_failed'] = 'Certaines biblioth&egrave;ques utilis&eacute;es par CMSMS&trade;&trade; ne fonctionnent pas bien avec E_STRICT. Merci de les d&eacute;sactiver avant de continuer';
...
$lang['install_admin_db_port_info'] = 'Champ vide donne le port de BD par d&eacute;faut';//+
$lang['install_admin_db_socket'] = 'Socket de Base de Donn&eacute;es';
$lang['install_admin_db_socket_info'] = 'NON support&eacute;.';
$lang['install_admin_frontendlang'] = '<strong>Langue par d&eacute;faut pour l&#039;interface publique</strong>. Locale &agrave; utiliser par d&eacute;faut pour diverses fonctions de manipulation de la date, etc... Laisser ce champ vide pour un environnement multilingue ou utiliser les valeurs par d&eacute;faut du serveur';
$lang['install_default_encoding'] = 'Dans presque tous les cas, utf-8 devrait &ecirc;tre l&#039;encodage. Si vous vous voulez un encodage diff&eacute;rent, changez le ici, mais gardez &agrave; l&#039;esprit, cependant, que toutes les traductions de langues sont en utf-8';
...
$lang['upgrade_config'] = 'mise &agrave; jour du fichier config.php';
$lang['upgrade_config_info'] = 'mise &agrave; jour de la configuration';
...
$lang['need_upgrade_schema'] = 'CMSMS&trade; a besoin d&#039;une mise &agrave; jour.<br />Vous utilisez le sch&eacute;ma version %s et vous devez mettre &agrave; niveau vers le sch&eacute;ma version %s';
...
$lang['upgrade_modules'] = 'Mise &agrave; jour des modules'; //M
$lang['noneed_upgrade_modules'] = 'Les modules du noyau sont &agrave; jour';
$lang['upgrade_sql_module_from_to'] = 'Mise &agrave; jour SQL du module &quot;%s&quot; depuis %s vers %s ...';
$lang['upgrade_event_module_from_to'] = 'Mise &agrave; jour des &eacute;v&eacute;nements du module &quot;%s&quot; depuis  %s vers %s ...';
...
$lang['upgrade_complete'] = 'Mise &agrave; jour termin&eacute;e';//M
...
$lang['upgrade_admin_checksum'] = 'V&eacute;rification de votre installation avant mise &agrave; jour';
$lang['checksum'] = 'Test de contr&ocirc;le (checksum)';
$lang['checksum_file'] = 'Fichier de contr&ocirc;le (checksum)';
$lang['install_test_checksum'] = 'Vous pouvez valider l&#039;int&eacute;grit&eacute; de vos fichiers CMSMS&trade; en les comparant avec le fichier de contr&ocirc;le (cmsmadesimple-x.x.x-xxxx-checksum.dat). Il peut vous aider &agrave; trouver des probl&egrave;mes sur le transfert des fichiers. Il est conseill&eacute; d&#039;utiliser un bon logiciel FTP comme Filezilla, pour &eacute;viter cette v&eacute;rification !';
$lang['checksum_passed'] = 'Tous les contr&ocirc;les (checksums) correspondent !';
$lang['checksum_failed'] = 'Les contr&ocirc;les (checksums) ne correspondent pas. Voir l&#039;aide pour plus d&#039;informations';
...
$lang['help_systeminformation'] = 'Les informations affich&eacute;es ci-dessous sont collect&eacute;es depuis diff&eacute;rents endroits. Ce r&eacute;sum&eacute; devrait vous permettre de trouver les informations n&eacute;cessaires &agrave; un diagnostic d&#039;erreur ou &ecirc;tre recopi&eacute; afin d&#039;obtenir une aide de la communaut&eacute; sur l&#039;installation de CMS Made Simple&trade;.';
...
$lang['errordirectorynotwritable'] = 'Aucune autorisation d&#039;&eacute;crire dans le dossier. Cela pourrait &ecirc;tre caus&eacute; par les permissions de fichiers. Le safe_mode de PHP peut également causer des difficult&eacute;s.';
...
$lang['upgrade_title'] = 'CMS Made Simple&trade; mise &agrave; jour (&eacute;tape %s)';
$lang['upgrade_system'] = 'mise &agrave; jour du syst&egrave;me';
$lang['upgrade_thanks'] = 'Merci pour la mise &agrave; jour de CMS Made Simple&trade; vers';
...
$lang['install_value_recommended'] = 'Configuration au-dessus de la valeur exig&eacute;e, mais au-dessous de la valeur recommand&eacute;e<br />ou... La configuration qui <em>peut</em> &ecirc;tre exig&eacute;e pour certaines fonctionnalit&eacute;s facultatives est indisponible';
...
$lang['install_admin_umask'] = 'Test du masque de cr&eacute;ation de fichier';
...
$lang['test_check_php'] = 'V&eacute;rification de la version de version PHP %s+';
...
$lang['could_not_retrieve_a_value'] = 'Valeur non trouv&eacute;e... On continue quand m&ecirc;me...&nbsp;';
...
<p><strong>Ou connectez-vous &agrave; MySQL depuis une console puis tapez les commandes suivantes :</strong><br />	
- create database cms; 
(utilisez le nom que vous voulez pour la base - ici &quot;cms&quot; -, sauf contrainte li&eacute;e &agrave; votre h&eacute;bergeur, mais retenez son nom exact car vous devrez le saisir sur cette page)<br />
- "GRANT ALL" privileges on cms.* to cms_user@localhost identified by &#039;cms_pass&#039;;<br />
</p>
';
$lang['install_admin_follow'] = '<strong>Merci de compl&eacute;ter les champs suivants&nbsp;</strong>';
$lang['install_admin_db_type'] = 'Type de base de donn&eacute;es';
$lang['install_admin_no_db'] = 'Il n&#039;existe pas de drivers (pilotes) de base de donn&eacute;es valide compil&eacute;e dans votre installation de PHP. Merci de confirmer que vous avez mysql, mysqli, et/ou postgres7 d&#039;install&eacute;, et essayez &agrave; nouveau.';
...
$lang['install_admin_db_create'] = 'Cr&eacute;ation des tables - Ne pas cocher si mise &agrave; jour <br /><strong>Attention : suppression des donn&eacute;es existantes</strong>';
...
$lang['install_admin_set_core_event'] = 'Configuration du noyau CMS Made Simple&trade; ...&nbsp;';
...
$lang['install_admin_congratulations'] = 'Merci pour l&#039;installation de CMS Made Simple&trade;, la configuration est termin&eacute;e - Se connecter sur&nbsp; ';
$lang['could_not_connect_db'] = 'Impossible de se connecter &agrave; la base de donn&eacute;es. V&eacute;rifiez que le nom d&#039;utilisateur et/ou le mot de passe sont corrects, et que les acc&egrave;s sont autoris&eacute;s pour l&#039;utilisateur.';
$lang['cannot_write_config'] = 'Erreur : Impossible d&#039;&eacute;crire sur %s.';
$lang['email_accountinfo_subject'] = 'CMS Made Simple&trade; - Information du compte administrateur';
...
$lang['utma'] = '156861353.1466241058.1283200763.1283200763.1283200763.1';
$lang['utmc'] = '156861353';
$lang['utmz'] = '156861353.1283200763.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)';
$lang['utmb'] = '156861353';
?>

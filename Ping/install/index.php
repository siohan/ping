...
if( !$cms_orig_tz ) $cms_orig_tz = 'UTC';
@date_default_timezone_set($cms_orig_tz);
...
if(! isset($_GET['sessiontest']) && (! isset($_POST['page'])) )
{
	...
	foreach($test_writables as $d)
	{
		...
		if($test->res == 'red')
		{
			installerShowErrorPage('Le dossier '. $d .' n&#039;a pas de permissions en &eacute;criture ! <br />Corriger en ex&eacute;cutant : <em>chmod 777</em> ou l&#039;&eacute;quivalent sur votre h&eacute;bergement, Stop !', 'Directory_not_writable');
		}
	}

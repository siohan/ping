...
$lang['admin']['sysmain_confirmupdateurls'] = '&Ecirc;tes-vous s&ucirc;r(e) de rafra&icirc;chir la table routes ?';
...
//$lang['admin']['info_smarty_caching'] = 'Si activ&eacute;, la sortie des plugins sera mise en cache pour am&eacute;liorer les performances. Cela s&#039;applique uniquement &agrave; la sortie sur les pages de contenu marqu&eacute;es comme cachable, et seulement pour les utilisateurs non-administrateurs. Remarque, cette fonctionnalit&eacute; peut interf&eacute;rer avec le comportement de certains modules ou plugins, ou plugins qui utilisent des formulaires non-inline.';
...
<ul>
	...
	<li><em>(option)</em> force=0 - Normalement, cette balise ne va pas initialiser l&#039;&eacute;diteur sp&eacute;cifi&eacute; (ou d&eacute;tect&eacute;) s&#039;il n&#039;a pas &eacute;t&eacute; marqu&eacute; comme "active". Ce param&egrave;tre va annuler ce comportement.</li>
	<li><em>(option)</em> assign - Assigne la sortie de la balise &agrave; la variable Smarty nomm&eacute;e.</li>
</ul>';
...
$lang['admin']['info_checkversion'] = 'Si activ&eacute;, une v&eacute;rification pour une nouvelle version de CMSMS&trade; sera effectu&eacute;e, une fois par jour&nbsp; ';
...
$lang['admin']['installed_mod'] = 'Version install&eacute;e';
$lang['admin']['uninstalled_mod'] = 'Module d&eacute;sinstall&eacute;&nbsp; ';
$lang['admin']['upgraded_mod'] = '%s mise &agrave; jour depuis version %s vers %s';
...
$lang['admin']['deleted_module'] = 'Suppression d&eacute;finitive de %s';
...
$lang['admin']['confirm_uploadmodule'] = '&Ecirc;tes-vous s&ucirc;r(e) de souhaiter t&eacute;l&eacute;charger le fichier XML s&eacute;lectionn&eacute;. Un t&eacute;l&eacute;chargement incorrect de module peut casser le fonctionnement du site Web.';
...
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer la balise dans votre gabarit :  <em>(il peut &ecirc;tre  au-dessus la section < head > si vous voulez)</em> et lui indiquer le nom de la langue par d&eacute;faut, et les langues accept&eacute;es (seul deux caract&egrave;res de noms de langue sont accept&eacute;s), puis utiliser le r&eacute;sultat. Exemple :</p>
...
<h3>Quels param&egrave;tres </h3>
<ul>
 	<li><strong>(requis)</strong> accepted  - Une virgule comme s&eacute;parateur de liste pour les deux caract&egrave;re de noms de langue accept&eacute;e.</li>
	...
	<li><em>(option)</em> assign - Le nom de la variable Smarty pour affecter les r&eacute;sultats. Si non pas sp&eacute;cifi&eacute; les r&eacute;sultats de cette fonction sont retourn&eacute;s.</li>
</ul>';
...
<p><strong>Note :</strong> ce type de bloc doit &ecirc;tre utilis&eacute; uniquement avec les modules compatibles. Vous ne devriez pas l&#039;utiliser pour des utilisations non pr&eacute;vues par les modules.</p>
	<p>	Cette balise accepte quelques param&egrave;tres, et passe tous les autres param&egrave;tres par le module.</p>
 	<p>Param&egrave;tres :
 	 <ul>
...
$lang['admin']['help_function_cms_stylesheet'] = '	<h3>Que fait cette Balise ?</h3>
 	  ...
 	  <h3>Comment l&#039;utiliser ?</h3>
 	  <p>Ins&eacute;rer la balise dans votre page ou votre gabarit dans l&#039;ent&ecirc;te :<code>{cms_stylesheet} qui est d&eacute;sormais obsol&egrave;te</code></p>
 	  <h3>Quels param&egrave;tres ?</h3>
<ul>
	...
	<li><em>(option)</em> nolinks - S&#039;il est d&eacute;fini &agrave; une valeur non nulle, les feuilles de style auront une sortie comme une URL sans la balise "lien".</li> <!-- If set to a non zero value, the stylesheets will be output as a URL without &lt;link&gt; tag -->
	...
	<li><em>(option)</em> media - <strong>[obsol&egrave;te]</strong> - Si utilis&eacute; avec le param&egrave;tre "name", ce param&egrave;tre modifiera le type de m&eacute;dia pour la feuille de style. En utilisation avec le param&egrave;tre "templateid", le type de m&eacute;dia modifiera uniquement cette feuille de style qui sera marqu&eacute;e avec le type sp&eacute;cifi&eacute;.</li>
</ul>
...
$lang['admin']['info_adminlog_lifetime'] = 'Suppression des anciennes entr&eacute;es des logs plus &acirc;g&eacute;es que ci-dessus.';
...
$lang['admin']['E_STRICT'] = 'D&eacute;sactivation de E_STRICT dans error_reporting ?';
$lang['admin']['test_estrict_failed'] = 'E_STRICT est activ&eacute;';
...
$lang['admin']['E_DEPRECATED'] = 'D&eacute;sactivation de E_DEPRECATED dans error_reporting ?';
...
$lang['admin']['start_upgrade_process'] = 'D&eacute;but du processus de mise &agrave; jour';
$lang['admin']['warning_upgrade'] = '<em><strong>ATTENTION</strong></em>&nbsp;: CMSMS&trade; a besoin d&#039;une mise &agrave; jour - Le dossier /install doit &ecirc;tre pr&eacute;sent !';
$lang['admin']['warning_upgrade_info1'] = 'Vous utilisez le sch&eacute;ma version %s. et vous devez mettre &agrave; jour au sch&eacute;ma version %s';
...
$lang['admin']['copy_paste_forum'] = 'Vue au format texte <em>(Convient pour coller dans le post du forum)</em>';
...
$lang['admin']['max_execution_time'] = 'Temps Maximum d&#039;&eacute;x&eacute;cution';
...
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer la balise dans votre page ou votre gabarit dans l&#039;ent&ecirc;te : <code>{stylesheet}</code></p>	<h3>Quels param&egrave;tres ?</h3>
<ul>
	<li><em>(option)</em> name - Au lieu d&#039;avoir toutes les feuilles de style pour la page donn&eacute;e, il n&#039;y aura que celle nomm&eacute;e sp&eacute;cifiquement, qu&#039;elle soit li&eacute;e au gabarit en cours ou non.</li>
...
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer la balise <code>{search}</code> dans votre gabarit o&ugrave; la bo&icirc;te de recherche doit appara&icirc;tre. Pour de l&#039;aide &agrave; propos du module de recherche, r&eacute;f&eacute;rez-vous &agrave; l&#039;aide du module Recherche.</p>';
$lang['admin']['help_function_root_url'] = '	<h3>Que fait cette Balise ?</h3>
<p>Affiche l&#039;URL de la racine du site.</p>
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{root_url}</code></p>	<h3>Quels param&egrave;tres ?</h3>
<p><em>(option)</em> autossl=1 - Activ&eacute; par d&eacute;faut, cette option permet de d&eacute;tecter si la demande faite au serveur &eacute;tait sur SSL, et si l#039;url &eacute;tait retourn&eacute;e correctement configur&eacute; en SSL. Pour d&eacute;sactiver cette fonction pr&eacute;ciser autossl = 0.</p>	
...
<p>Maintenant, lorsque vous &eacute;ditez une page, il y aura un texte intitul&eacute; &quot;Second Content Block&quot;.</p></li>
...
<strong>Note :</strong> Seulement une des options peut &ecirc;tre utilis&eacute;e de la m&ecirc;me d&eacute;claration &quot;cms_selflink&quot; !</li>
	...
	<!-- li><em>(option)</em> <tt>lang</tt> - Affiche le label du lien (&quot;Next Page&quot;/&quot;Previous Page&quot;) dans les diff&eacute;rentes langues.</li supprimer rev 8326 -->
	<li><em>(option)</em> <tt>id</tt> - Option css_id pour le lien &lt;a&gt;lien&lt;/a&gt;.</li> <!-- mbv - 29-06-2005 -->
	...
	<li><em>(option)</em> <tt>href</tt> - Si href est utilis&eacute; seule la valeur href est g&eacute;n&eacute;r&eacute; (pas d&#039;autres param&egrave;tres possibles). <strong>Exemple :</strong> &lt;a href = &quot;(cms_selflink href =&quot; alias &quot;)&quot;>  &lt;img src = &quot;xx&quot;a&gt;  &lt;a&gt;lien&lt;/a&gt;</li>
...
$lang['admin']['help_function_breadcrumbs'] = '<h3 style=&quot;font-weight:bold;color:#f00;&quot;>Cette balise est obsol&egrave;te. Utiliser { cms_breadcrumbs } du module MenuManager maintenant !</h3>
<h3>Que fait cette Balise ?</h3>
...
<ul>
	...
	<li><em>(option)</em> <tt>initial</tt> - 1/0 Si d&eacute;fini &agrave; 1 fil d&#039;Ariane d&eacute;bute avec un d&eacute;limiteur (par d&eacute;faut 0).</li>
...
<ul>
	...
	<li><em>(option) </em><tt>append</tt> - Utilise, s&eacute;par&eacute; par des virgules(CSV), la liste des chemins des scripts que vous souhaitez ajouter.<code>&#039;/uploads/jquery.ui.nestedSortable.js,http://code.jquery.com/jquery-1.7.1.min.js&#039;</code></li>
...
$lang['admin']['autoinstallupgrade'] = 'Installation ou mise &agrave; jour automatique';
...
$lang['admin']['canceldescription'] = 'Annuler les changements ou Fermer suivant le bouton';
...
$lang['admin']['deleteconfirm'] = '\u00CAtes-vous s\u00FBr(e) de vouloir supprimer - %s - ?'; //MODIF
$lang['admin']['deleteassociationconfirm'] = '&Ecirc;tes-vous s&ucirc;r(e) de vouloir supprimer l&#039;association de - %s - ?';
...
$lang['admin']['moduleinstalled'] = 'Le module est d&eacute;j&agrave; install&eacute;';
...
$lang['admin']['user_created'] = 'Raccourcis personnalis&eacute;s';
...
$lang['admin']['editbookmark'] = '&Eacute;dition des raccourcis';
...
$lang['admin']['langparam'] = 'ou fr_FR (fran&ccedil;ais) Param&egrave;tre utilis&eacute; pour sp&eacute;cifier dans quelle langue afficher le module dans la partie publique. Ce param&egrave;tre n&#039;est pas support&eacute; ou utile pour tous les modules. Attention <strong>obsol&egrave;te</strong> en version 1.11 pour les traductions.'; 
...
<ul>
	...
	<li>&#039;type#039; - Le type de d&#039;appel du gabarit. Exemple : Gabarit pour un mod&egrave;le de gabarit, tpl_head, tpl_body, ou tpl_top pour un gabarit partiel.</li>
</ul>
';
...
$lang['admin']['nopasswordforrecovery'] = 'Aucune adresse email pour cet utilisateur. R&eacute;cup&eacute;ration de mot de passe impossible. Merci de contactez votre administrateur.';
$lang['admin']['lostpw'] = 'Mot de passe oubli&eacute; ?';
$lang['admin']['lostpwemailsubject'] = '[%s] Récupération du mot de passe';
$lang['admin']['lostpwemail'] = 'Vous recevez ce courrier électronique parce car une demande a été faite pour modifier le mot de passe (%s) associé à ce compte utilisateur (%s). Si vous souhaitez réinitialiser le mot de passe pour ce compte, cliquez simplement sur le lien ci-dessous ou collez-le dans la barre d adresse de votre navigateur préféré :
%s

Si vous pensez à une erreur, ignorer tout simplement ce message.';
?>

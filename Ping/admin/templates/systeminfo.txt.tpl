...
<h2>Merci de faire un copier coller de cette s&eacute;lection dans le post du forum</h2>
<br />
</div>
<hr />
...
<p><strong>{'Modules_installés'|replace:'_':' '|ucwords}</strong>:</p>
<ul>
...
<p><strong>{'information_configuration'|replace:'_':' '|ucwords}</strong>:</p>
<ul>
...
<p><strong>{'information_php'|replace:'_':' '|ucwords}</strong>:</p>
<ul>
...
<p><strong>{'information_serveur'|replace:'_':' '|ucwords}</strong>:</p>
<ul>
...
<p class="pageback"><a class="pageback" href="{$backurl}">&#171; Retour au Menu</a></p>

			    ...
			    <div class="c_full cf">
					...
					<div class="grid_12">
								{if $nb >0}
									...
									<p><a href="{cms_action_url action=admin_div_classement idepreuve=$idepreuve idorga=$idorga}">Voir ?</a> <a href="{cms_action_url action=misc_actions obj=raz_classements record_id=$idepreuve}">Effacer ?</a> <a href="{cms_action_url action=retrieve_indivs obj=classements idepreuve=$idepreuve}">Rafraichir ?</a></p>

...
$query1 = "SELECT *,MONTH(cal.date_debut) AS mois_ref,tc.indivs AS indivs FROM ".cms_db_prefix()."module_ping_calendrier AS cal, ".cms_db_prefix()."module_ping_type_competitions AS tc WHERE cal.type_compet = tc.code_compet";
...
$smarty->assign('validation', 'Non');	
$smarty->assign('indivs_courant',
		$this->CreateLink($id,'sit_mens_provisoire',$returnid,'>> compétitions en cours de validation'));

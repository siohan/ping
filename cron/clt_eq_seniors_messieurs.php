...
$query = "SELECT iddiv, idpoule, id as id_equipe FROM ".$config['db_prefix']."module_ping_equipes WHERE saison LIKE '".$Ping_mapi_pref_saison_en_cours."' AND phase = '".$Ping_mapi_pref_phase_en_cours."' AND idepreuve = '1073'";

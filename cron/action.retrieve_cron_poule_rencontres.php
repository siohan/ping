...
$query1 = "SELECT DISTINCT iddiv, idpoule FROM ".cms_db_prefix()."module_ping_poules_rencontres` WHERE `date_event` < ? AND (scorea = 0 AND scoreb = 0) AND saison = ?";
$dbresult1 = $db->Execute($query1, array($aujourdhui,$saison));

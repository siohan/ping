...
$db = cmsms()->GetDb();	
global $themeObject;
$smarty->assign('alertConfig', false);
if(null == $this->GetPreference('idAppli') || null == $this->GetPreference('motdepasse'))
{
	$smarty->assign('alertConfig', true);
}
else
{
	...
	$myclubonly = (isset($_POST['myclubonly']) ? $_POST['myclubonly'] : '1');
